...
Config.StartLocation = vector4(-893.32, -2401.42, 14.02, 146.73) -- Start location for oxy run
...
Config.MinCops = 3 -- Minimum required amount of cops
Config.CallCopsChance = 75 -- %Chance to alert police

Config.LaunderChance = 100 -- %Chance to launder money
Config.LaunderItem = 'markedbills'

Config.OxyChance = 0 -- %Chance to receive oxy
Config.OxyItem = 'oxy'

Config.RareLoot = 0 -- %Chance to receive a rare loot item
