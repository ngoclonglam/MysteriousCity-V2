...
QBShared.Items = {
	...
	['weed_seed'] 				 	 = {['name'] = 'weed_seed', 			    	['label'] = 'Weed Seed', 				['weight'] = 0, 		['type'] = 'item', 		['image'] = 'weed_seed.png', 		    ['unique'] = false, 	['useable'] = true, 	['shouldClose'] = true,	   ['combinable'] = nil,   ['description'] = 'A weed seed of normal'},
	...
	['emerald'] 				 	 = {['name'] = 'emerald', 			  			['label'] = 'Lục Bảo', 					['weight'] = 50, 		['type'] = 'item', 		['image'] = 'emerald.png', 			    ['unique'] = false, 	['useable'] = false, 	['shouldClose'] = false,   ['combinable'] = nil,   ['description'] = 'Ngọc lục bảo quý giá'},

    -- Fishing Items
	["fish"] 			 		 	 = {["name"] = "fish", 							["label"] = "Cá Nhỏ",                   ["weight"] = 1000,      ["type"] = "item",      ["image"] = "fish.png",                 ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["killerwhalemeat"] 			 = {["name"] = "killerwhalemeat", 				["label"] = "Cá Voi Sát Thủ",          	["weight"] = 5000,       ["type"] = "item",      ["image"] = "killerwhalemeat.png",      ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["stingraymeat"] 			     = {["name"] = "stingraymeat", 				    ["label"] = "Cá Đuối",             		["weight"] = 5000,      ["type"] = "item",      ["image"] = "stingraymeat.png",         ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["tigersharkmeat"] 			     = {["name"] = "tigersharkmeat", 				["label"] = "Cá Hổ",           			["weight"] = 5000,      ["type"] = "item",      ["image"] = "tigersharkmeat.png",       ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["catfish"] 			         = {["name"] = "catfish", 				        ["label"] = "catfish",                  ["weight"] = 5000,      ["type"] = "item",      ["image"] = "catfish.png",              ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["salmon"] 			             = {["name"] = "salmon", 				        ["label"] = "Cá Hồi",                   ["weight"] = 4000,      ["type"] = "item",      ["image"] = "salmon.png",               ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["largemouthbass"] 			     = {["name"] = "largemouthbass", 				["label"] = "largemouthbass",           ["weight"] = 3500,      ["type"] = "item",      ["image"] = "largemouthbass.png",       ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["goldfish"] 			         = {["name"] = "goldfish", 			        	["label"] = "Cá Vàng",                  ["weight"] = 3000,      ["type"] = "item",      ["image"] = "goldfish.png",             ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["redfish"] 			         = {["name"] = "redfish", 			        	["label"] = "Cá Đỏ",                    ["weight"] = 2500,      ["type"] = "item",      ["image"] = "redfish.png",              ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["bluefish"] 			         = {["name"] = "bluefish", 			        	["label"] = "Cá Xanh",                  ["weight"] = 2000,      ["type"] = "item",      ["image"] = "bluefish.png",             ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["stripedbass"] 			     = {["name"] = "stripedbass", 			        ["label"] = "stripedbass",              ["weight"] = 1500,      ["type"] = "item",      ["image"] = "stripedbass.png",          ["unique"] = false,     ["useable"] = true,     ["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Cá này là đến từ những chàng cần thủ."},
	["fishingrod"] 			 		 = {["name"] = "fishingrod", 					["label"] = "Cần Câu Cá", 				["weight"] = 5000, 		["type"] = "item", 		["image"] = "fishingrod.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,	   ["combinable"] = nil,   ["description"] = "Một cần câu cho những cuộc phiêu lưu với bạn bè!!"},
	["fishingbait"] 			 	 = {["name"] = "fishingbait", 					["label"] = "Mồi Câu Cá", 				["weight"] = 500, 		["type"] = "item", 		["image"] = "fishingbait.png", 			["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,	   ["combinable"] = nil,   ["description"] = "Một mồi câu cá"},
	["boombox"] 			     	 = {["name"] = "boombox", 						["label"] = "Boombox", 					["weight"] = 5000, 		["type"] = "item", 		["image"] = "boombox.png", 				["unique"] = true, 		["useable"] = true, 	["shouldClose"] = true,	   ["combinable"] = nil,   ["description"] = "Boombox nơi âm nhạc vang mãi."},
	["policecard"] 				 	 = {["name"] = "policecard", 					["label"] = "Police Badge", 			["weight"] = 0, 		["type"] = "item", 		["image"] = "badge.png", 				["unique"] = false, 	["useable"] = true, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Huy hiệu đặc biệt về thực thi pháp luật"},

    -- Hunting items
	["leather"] 				 	 = {["name"] = "leather", 						["label"] = "Da thuộc", 			    ["weight"] = 100, 		["type"] = "item", 		["image"] = "leather.png", 			    ["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Da nai"},
	["meat"] 				 	 	 = {["name"] = "meat", 							["label"] = "Meat", 			        ["weight"] = 200, 		["type"] = "item", 		["image"] = "meat.png", 			    ["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Thịt nai"},

    -- Slaughter items
	["alive_chicken"] 				 = {["name"] = "alive_chicken", 				["label"] = "Gà Con", 			        ["weight"] = 2000, 		["type"] = "item", 		["image"] = "alive_chicken.png", 	    	["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Gà con"},
	["slaughtered_chicken"] 		 = {["name"] = "slaughtered_chicken", 			["label"] = "Gà Làm thịt", 			    ["weight"] = 1000, 		["type"] = "item", 		["image"] = "slaughtered_chicken.png", 		["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Thịt gà"},
	["packaged_chicken"] 		 	 = {["name"] = "packaged_chicken", 				["label"] = "Gà Đóng Gói", 			    ["weight"] = 1500, 		["type"] = "item", 		["image"] = "packaged_chicken.png", 		["unique"] = false, 	["useable"] = false, 	["shouldClose"] = true,    ["combinable"] = nil,   ["description"] = "Gà đóng gói"},

	-- Lumberjack job
    ['wood_cut'] 				 	 = {['name'] = 'wood_cut', 			  			['label'] = 'Gỗ', 						['weight'] = 1000, 		['type'] = 'item', 		['image'] = 'lumber.png', 					['unique'] = false, 	['useable'] = false, 	['shouldClose'] = false,   ['combinable'] = nil,   ['description'] = 'Gỗ mới chặt'},
    ['wood_proc'] 				 	 = {['name'] = 'wood_proc', 			  		['label'] = 'Miếng Gỗ', 				['weight'] = 500, 		['type'] = 'item', 		['image'] = 'woodplank.png', 				['unique'] = false, 	['useable'] = false, 	['shouldClose'] = false,   ['combinable'] = nil,   ['description'] = 'Gỗ đã qua xử lý'},
    ['tree_bark'] 				 	 = {['name'] = 'tree_bark', 			  		['label'] = 'Vỏ Cây', 					['weight'] = 500, 		['type'] = 'item', 		['image'] = 'treebark.png', 				['unique'] = false, 	['useable'] = false, 	['shouldClose'] = false,   ['combinable'] = nil,   ['description'] = 'Vỏ cây rơi vụn sau khi chặt'},
	...
	['mining_stone'] 			     = {['name'] = 'mining_stone', 					['label'] = 'Mined Stone', 				['weight'] = 2000, 		['type'] = 'item', 		['image'] = 'mining_stone.png', 			['unique'] = false, 		['useable'] = true, 	['shouldClose'] = true,	   ['combinable'] = nil,   ['description'] = 'Mined Stone'},
	...
	-- t1ger drugs
	-- ['coca_leaf'] 		= {['name'] = 'coca_leaf', 			['label'] = 'Coke Leaf', 			['weight'] = 0, ['type'] = 'item', ['image'] = 'coca_leaf.png', 		['unique'] = false, ['useable'] = false, ['shouldClose'] = false, ['combinable'] = nil, ['description'] = 'Cocaine leaf'},
	['coke_cutted'] 	= {['name'] = 'coke_cutted', 		['label'] = 'Cutted Coke', 			['weight'] = 0, ['type'] = 'item', ['image'] = 'coke_cutted.png', 		['unique'] = false, ['useable'] = false, ['shouldClose'] = false, ['combinable'] = nil, ['description'] = 'Cutted cocaine'},
	['coke_packaged'] 	= {['name'] = 'coke_packaged', 		['label'] = 'Packaged Coke', 		['weight'] = 0, ['type'] = 'item', ['image'] = 'coke_packaged.png', 	['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Packaged cocaine'},

	['meth_ingredient'] = {['name'] = 'meth_ingredient', 	['label'] = 'Meth Ingredients', 	['weight'] = 0, ['type'] = 'item', ['image'] = 'meth_ingredient.png', 	['unique'] = false, ['useable'] = false, ['shouldClose'] = false, ['combinable'] = nil, ['description'] = 'Meth ingredients'},
	['meth_pure'] 		= {['name'] = 'meth_pure', 			['label'] = 'Pure Meth', 			['weight'] = 0, ['type'] = 'item', ['image'] = 'meth_pure.png', 		['unique'] = false, ['useable'] = false, ['shouldClose'] = false, ['combinable'] = nil, ['description'] = 'Pure meth'},
	['meth_packaged'] 	= {['name'] = 'meth_packaged', 		['label'] = 'Packaged Meth', 		['weight'] = 0, ['type'] = 'item', ['image'] = 'meth_packaged.png', 	['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Packed meth'},

	['weed_leaf'] 		= {['name'] = 'weed_leaf', 			['label'] = 'Weed Leaf', 			['weight'] = 0, ['type'] = 'item', ['image'] = 'weed_leaf.png', 		['unique'] = false, ['useable'] = false, ['shouldClose'] = false, ['combinable'] = nil, ['description'] = 'Weed leaf'},
	['weed_untrimmed'] 	= {['name'] = 'weed_untrimmed', 	['label'] = 'Untrimmed Weed', 		['weight'] = 0, ['type'] = 'item', ['image'] = 'weed_untrimmed.png', 	['unique'] = false, ['useable'] = false, ['shouldClose'] = false, ['combinable'] = nil, ['description'] = 'Untrimmed weed'},
	['weed_packaged'] 	= {['name'] = 'weed_packaged', 		['label'] = 'Packaged Weed', 		['weight'] = 0, ['type'] = 'item', ['image'] = 'weed_packaged.png', 	['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Packaged weed'},
	['weed_joint'] 		= {['name'] = 'weed_joint', 		['label'] = 'Joint', 				['weight'] = 0, ['type'] = 'item', ['image'] = 'weed_joint.png', 		['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Weed joint'},

	['chemicals'] 		= {['name'] = 'chemicals', 			['label'] = 'Chất Hóa Học', 		['weight'] = 0,   ['type'] = 'item', ['image'] = 'chemicals.png', 		['unique'] = false, ['useable'] = false, ['shouldClose'] = false, ['combinable'] = nil, ['description'] = 'Chất hóa học rất kích thích'},
	['hq_scale'] 		= {['name'] = 'hq_scale', 			['label'] = 'Cân HQ', 				['weight'] = 0,   ['type'] = 'item', ['image'] = 'hq_scale.png', 		['unique'] = false, ['useable'] = false, ['shouldClose'] = false, ['combinable'] = nil, ['description'] = 'Cân để đo gram'},
	['plastic_bags'] 	= {['name'] = 'plastic_bags', 		['label'] = 'Túi nhựa', 			['weight'] = 0,   ['type'] = 'item', ['image'] = 'plastic_bags.png', 	['unique'] = false, ['useable'] = false, ['shouldClose'] = false, ['combinable'] = nil, ['description'] = 'Túi nhựa nhưng đựng cái quan trọng'},
	['dice'] 			= {['name'] = 'dice', 				['label'] = 'Xí Ngầu', 				['weight'] = 0,   ['type'] = 'item', ['image'] = 'dice.png', 			['unique'] = true, 	['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Xí ngầu nơi chúng ta trắng tay'},
	['wheat_seed'] 		= {['name'] = 'wheat_seed', 		['label'] = 'Hạt Lúa Mạch', 		['weight'] = 100, ['type'] = 'item', ['image'] = 'wheat_seed.png', 		['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Hạt lúa mạch để trồng trọt'},
	['orange_seed'] 	= {['name'] = 'orange_seed', 		['label'] = 'Hạt Trồng Cam', 		['weight'] = 100, ['type'] = 'item', ['image'] = 'orange_seed.png', 	['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Hạt cam để trồng trọt'},
	['coffee_seed'] 	= {['name'] = 'coffee_seed', 		['label'] = 'Hạt Cà Phê', 			['weight'] = 100, ['type'] = 'item', ['image'] = 'coffe_seed.png', 		['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Hạt cà phê để trồng trọt'},
	['bean_seed'] 		= {['name'] = 'bean_seed', 			['label'] = 'Hạt Đậu', 				['weight'] = 100, ['type'] = 'item', ['image'] = 'bean_seed.png', 		['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Hạt đậu để trồng trọt'},
	['giesskanne_voll'] = {['name'] = 'giesskanne_voll', 	['label'] = 'Can Nước Đầy', 		['weight'] = 200, ['type'] = 'item', ['image'] = 'giesskanne_voll.png', ['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Can nước thật là đầy'},
	['giesskanne_leer'] = {['name'] = 'giesskanne_leer', 	['label'] = 'Can Nước Trống', 		['weight'] = 100, ['type'] = 'item', ['image'] = 'giesskanne_leer.png', ['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Can nước trống rỗng'},
	['wheat'] 			= {['name'] = 'wheat', 				['label'] = 'Lúa Mạch', 			['weight'] = 150, ['type'] = 'item', ['image'] = 'wheat.png', 			['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Lúa mạch sau khi trồng'},
	['orange'] 			= {['name'] = 'orange', 			['label'] = 'Cam', 					['weight'] = 150, ['type'] = 'item', ['image'] = 'orange.png', 			['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Cam ngọt sau khi trồng'},
	['coffeee'] 		= {['name'] = 'coffeee', 			['label'] = 'Cà Phê', 				['weight'] = 150, ['type'] = 'item', ['image'] = 'coffeee.png', 		['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Cà phê sau khi trồng'},
	['bean'] 			= {['name'] = 'bean', 				['label'] = 'Đậu Trưởng Thành', 	['weight'] = 150, ['type'] = 'item', ['image'] = 'bean.png', 			['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Đậu xanh sau khi trồng'},
	['cherry'] 			= {['name'] = 'cherry', 			['label'] = 'Trái Cherry', 			['weight'] = 500, ['type'] = 'item', ['image'] = 'cherry.png', 			['unique'] = false, ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Trái cherry mộng nước'},
	['w_cherry'] 		= {['name'] = 'w_cherry', 			['label'] = 'Cherry Non', 			['weight'] = 100, ['type'] = 'item', ['image'] = 'w_cherry.png', 		['unique'] = false, ['useable'] = false, ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Trái cherry chưa rửa'},
	['news_paper'] 		= {['name'] = 'news_paper', 		['label'] = 'Tờ Báo', 				['weight'] = 50,  ['type'] = 'item', ['image'] = 'news_paper.png', 		['unique'] = true,  ['useable'] = true,  ['shouldClose'] = true,  ['combinable'] = nil, ['description'] = 'Một tờ báo có những thông tin sốt nổi'},

	-- Myth Bar
	["traicay"]				= {["name"] = "traicay",			["label"] = "Trái Cây",			["weight"] = 200,	["type"] = "item",	["image"] = "traicay.png",		["unique"] = false,	["useable"] = true,		["shouldClose"] = true,		["combinable"] = nil,   ["description"] = "Dĩa trái cây đủ hương vị 4 mùa"},
    ...
    ['gift-rare'] 				 		 	 = {['name'] = 'gift-rare', 			  	  			['label'] = 'Quà Trung Cấp', 				['weight'] = 100, 		['type'] = 'item', 		['image'] = 'gift-rare.png', 				['unique'] = false, 	['useable'] = true, 	['shouldClose'] = true,	   ['combinable'] = nil,   ['description'] = 'Gói quà trung cấp từ thương nhân thần bí', ['isBound'] = true},
    ['gift-epic'] 				 		 	 = {['name'] = 'gift-epic', 			  	  			['label'] = 'Quà Cao Cấp', 					['weight'] = 100, 		['type'] = 'item', 		['image'] = 'gift-epic.png', 				['unique'] = false, 	['useable'] = true, 	['shouldClose'] = true,	   ['combinable'] = nil,   ['description'] = 'Gói quà cao cấp từ thương nhân thần bí', ['isBound'] = true},
    ['daily-reset-card'] 				 	 = {['name'] = 'daily-reset-card', 			  	  		['label'] = 'Thẻ làm mới nhiệm vụ', 		['weight'] = 100, 		['type'] = 'item', 		['image'] = 'daily-reset-card.png', 		['unique'] = false, 	['useable'] = true, 	['shouldClose'] = true,	   ['combinable'] = nil,   ['description'] = 'Thẻ làm mới nhiệm vụ hàng ngày.', ['isBound'] = true},
	...
	['strippedbass'] = {
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá này có thể vược thác nước'
	},
	['silverymonnow'] = {
		['name'] = 'silverymonnow',
		['label'] = 'Cá Chim Khoang',
		['weight'] = 100,
		['type'] = 'item',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá có bộ khoang giống như chim'
	},
	['goldentrout'] = {
		['name'] = 'goldentrout',
		['label'] = 'Cá Hồi Vàng',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá hồi có vảy bằng vàng'
	},
	['bluegill'] = {
		['name'] = 'bluegill',
		['label'] = 'Cá Mang Xanh',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá có cái mang màu xanh mang hương vị của biển cả'
	},
	['tench'] = {
		['name'] = 'tench',
		['label'] = 'Cá Chép Nhớt',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá chép nhưng hơi nhớt'
	},
	['whitefish'] = {
		['name'] = 'whitefish',
		['label'] = 'Cá Trắng',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá này toàn thân trắng tinh'
	},
	['crappie'] = {
		['name'] = 'crappie',
		['label'] = 'Cá Crappie',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá crappie không thể có trong từ điển Việt Nam'
	},
	['cruciancarp'] = {
		['name'] = 'cruciancarp',
		['label'] = 'Cá Chép Diếc',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá chép này có thể bị điếc chăng'
	},
	['bluebackherring'] = {
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Một loại cá trích có lưng màu xanh thật huyền bí'
	},
	['bulltrout'] = {
		['name'] = 'bulltrout',
		['label'] = 'Cá Hồi Bò',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Một trong những giống cá hồi có khối lượng nặng nhất'
	},
	['laketrout'] = {
		['name'] = 'laketrout',
		['label'] = 'Cá Hồi Hồ',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá này chỉ có kiếm được ở các hồ nước lân cận'
	},
	['perch'] = {
		['name'] = 'perch',
		['label'] = 'Cá Pecca',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá này cùng họ với cá Vược, có nguồn gốc từ Hy Lạp'
	},
	['chub'] = {
		['name'] = 'chub',
		['label'] = 'Cá Chub',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Giống cá nhỏ sống ở hồ'
	},
	['colorodopikeminnow'] = {
		['name'] = 'colorodopikeminnow',
		['label'] = 'Cá Chép Colorodo',
		['weight'] = 200,
		['type'] = 'item',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Sinh sống tại lưu vực sông Colorado'
	},
	['drumfish'] = {
		['name'] = 'drumfish',
		['label'] = 'Cá Đù',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Nhìn nó đù vậy thôi chứ nó đù thật'
	},
	['wallaye'] = {
		['name'] = 'wallaye',
		['label'] = 'Cá WallEye',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Thuộc họ cá Vược và sinh sống tại Canada'
	},
	['americanshad'] = {
		['name'] = 'americanshad',
		['label'] = 'Cá Trích Mỹ',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cá này từ Bắc Thái Bình Dương du nhập sang Mỹ'
	},
	['palidsturgeon'] = {
		['name'] = 'palidsturgeon',
		['label'] = 'Cá Tầm Da Vàng',
		['weight'] = 300,
		['type'] = 'item',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Loài cá vây tia có nguy cơ tuyệt chủng'
	},
	['pike'] = {
		['name'] = 'pike',
		['label'] = 'Cá Chó',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Loài cá điển hình của vùng nước lợ'
	},
	['blackcrappie'] = {
		['name'] = 'blackcrappie',
		['label'] = 'Cá Crappie Đen',
		['weight'] = 300,
		['type'] = 'item',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Trên vây có lốm đốm đen, thuộc dòng cá Crappie'
	},
	['bream'] = {
		['name'] = 'bream',
		['label'] = 'Cá Tráp',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Loài cá sống ở nước ngọt lẫn nước mặn'
	},
	['brooktrout'] = {
		['name'] = 'brooktrout',
		['label'] = 'Cá Hồi Suối',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Loài cá vượt suối di cư theo đàn'
	},
	['shortnosesucker'] = {
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Loài cá có đầu lớn và môi thịt mỏng'
	},
	['smallmouthbass'] = {
		['name'] = 'smallmouthbass',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Giống cá vược đen ở vùng nước ngọt'
	},
	['arowana'] = {
		['name'] = 'arowana',
		['label'] = 'Cá Rồng',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Dân chơi cá chắc chắn biết loại cá này'
	},
	['sweetfish'] = {
		['name'] = 'sweetfish',
		['label'] = 'Cá Thơm',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Dân gian người ta gọi cá này là Cá Hương'
	},
	['whitebass'] = {
		['name'] = 'whitebass',
		['label'] = 'Cá Vược Trắng',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Có rất nhiều tên như Cá Vược Bạc, Cá Vược Cát,..'
	},
	['alabamasturgeon'] = {
		['name'] = 'alabamasturgeon',
		['label'] = 'Cá Tầm Alabama',
		['weight'] = 400,
		['type'] = 'item',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Loài cá cực kỳ quý hiếm tại sông Alabama'
	},
	['lakesturgeon'] = {
		['name'] = 'lakesturgeon',
		['label'] = 'Cá Tầm Hồ',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Loài cá có thịt cực ngon, sống tại hồ Michigan'
	},
	['koicarpblack'] = {
		['name'] = 'koicarpblack',
		['label'] = 'Cá Chép Koi Đen',
		['weight'] = 500,
		['type'] = 'item',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Tương truyền mang lại sự giàu sang phú quý'
	},
	['lahontancutthroattrout'] = {
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Là loài cá lớn nhất thuộc cá Hồi mũi nhọn, cực kỳ quý hiếm'
	},
	['spoonlurebait'] = {
		['name'] = 'spoonlurebait',
		['label'] = 'Mồi Thìa Lượn',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Mồi này có hình như một chiếc thìa'
	},
	['threesidedbait'] = {
		['name'] = 'threesidedbait',
		['label'] = 'Mồi Ba Mặt',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cái mồi này có tận ba bên'
	},
	['tailfishbait'] = {
		['name'] = 'tailfishbait',
		['label'] = 'Mồi Đuôi Cá',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Mồi này làm từ đuôi cá thật là thông minh'
	},
	['doublehookbait'] = {
		['name'] = 'doublehookbait',
		['label'] = 'Mồi Móc Đôi',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Mồi này cá mà cắn câu thì không thoát đâu được'
	},
	['triplehooksbait'] = {
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Mồi tử thần của mọi loài cá nhỏ'
	},
	['woodenrod'] = {
		['name'] = 'woodenrod',
		['label'] = 'Cần Gỗ Mun',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cần câu gỗ 1 sao, chuyên câu cá phổ biến'
	},
	['slimmaterialrod'] = {
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cần có dây cước làm từ lông chim màu bạc'
	},
	['danishrod'] = {
		['name'] = 'danishrod',
		['label'] = 'Cần Cá Đuối',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Cần này được làm từ da của cá đuối'
	},
	['koidrod'] = {
		['name'] = 'koidrod',
		['label'] = 'Cần Thần Koi',
		...
		['shouldClose'] = false,
		['combinable'] = nil,
		['description'] = 'Trong lịch sử, nghe nói cần này đã là sát thủ của những con cá Koi'
	},
	['finewood'] = {
		['name'] = 'finewood',
		['label'] = 'Cần Phượng Hoàng',
		['weight'] = 5000,
		['type'] = 'item',
		['image'] = 'finewood.png',
		['unique'] = false,
	...
	['platecard'] 				 	 = {['name'] = 'platecard',						['label'] = 'Thẻ Đổi Biển Số', 				['weight'] = 0, 		['type'] = 'item', 		['image'] = 'platecard.png', 				['unique'] = true, 		['useable'] = true, 	['shouldClose'] = true,	   ['combinable'] = nil,   ['description'] = "Thẻ đổi biển số xe"},
	...
	['voucher_free'] 				 = {['name'] = 'voucher_free',					['label'] = 'Voucher Free Xe', 				['weight'] = 100, 		['type'] = 'item', 		['image'] = 'voucher_free.png', 			['unique'] = true, 	    ['useable'] = false, 	['shouldClose'] = true,    	   ['combinable'] = nil,   ['description'] = "Voucher miễn phí xe dưới 300k$ (không quy đổi thành tiền)"},
}
