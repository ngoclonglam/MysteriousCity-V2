...
Config.Gifts = {
    ...
    ["halloween_gift"] = {
        ...
        { type = "item", name = "renamecard", luck = {min = 12, max = 30} },
        { type = "item", name = "phonecard", luck = {min = 31, max = 49} },
        { type = "item", name = "carcard", luck = {min = 50, max = 68} },
        { type = "money", amount = math.random(100, 500), luck = {min = 69, max = 100} },
    },
    ["gift-common"] = {
