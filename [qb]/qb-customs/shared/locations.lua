...
Config.Locations = {
    ['Innocence'] = {
        ...
        blip = {
            label = 'Car Dealer',
            coords = vector3(-344.15, -920.14, 32.93),
            sprite = 72,
            scale = 0.65,
            color = 0,
            display = 4,
        ...
        zones = {
            { coords = vector3(-344.15, -920.14, 32.93), length = 6.0, width = 4.0, heading = 127.94, minZ = 30.93, maxZ = 34.93 },
            { coords = vector3(-333.64, -921.77, 32.91), length = 6.0, width = 4.0, heading = 164.31, minZ = 30.91, maxZ = 34.91 },
            { coords = vector3(-341.94, -909.86, 32.87), length = 6.0, width = 4.0, heading = 76.94, minZ = 30.87, maxZ = 34.87 },
        }
    },
