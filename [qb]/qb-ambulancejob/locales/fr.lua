local Translations = {
    ...
    info = {
        ...
        revive_player_a = 'Réanimer quelqu\'un ou vous même (Admin)',
        player_id = 'ID joueur (Peut être vide)',
        pain_level = 'Definir le niveau de douleur d\'un joueur ou de vous même (Admin)',
        kill = 'Tuer un joueur ou vous même (Admin)',
        heal_player_a = 'Soigner un joueur ou vous même (Admin)',
    },
    mail = {
