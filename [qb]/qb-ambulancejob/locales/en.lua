local Translations = {
    ...
    info = {
        ...
        revive_player_a = 'Revive A Player or Yourself (Admin)',
        player_id = 'Player ID (may be empty)',
        pain_level = 'Set Yours or A Players Pain Level (Admin)',
        kill = 'Kill A Player or Yourself (Admin)',
        heal_player_a = 'Heal A Player or Yourself (Admin)',
    },
    mail = {
