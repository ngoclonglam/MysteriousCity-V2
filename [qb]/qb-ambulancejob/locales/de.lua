local Translations = {
    ...
    info = {
        ...
        revive_player_a = 'Belebe einen Spieler oder dich selbst (Admin)',
        player_id = 'Spieler ID (may be empty)',
        pain_level = 'Setzt dein oder eines Spielers schmerzlevel (Admin)',
        kill = 'Töte einen Spieler oder dich selbst (Admin)',
        heal_player_a = 'Keile einen Spieler oder dich selbst (Admin)',
    },
    mail = {
