local Translations = {
    ...
    info = {
        ...
        respawn_revive = 'GIỮ [~r~E~s~] VỀ BỆNH VIỆN(MẤT HẾT ~r~ITEM~s~)',
        bleed_out = 'BẠN SẼ BỊ MẤT MÁU TỚI CHẾT TRONG VÒNG: ~r~%{time}~s~ GIÂY',
        bleed_out_help = 'BẠN SẼ BỊ MẤT MÁU TỚI CHẾT TRONG VÒNG: ~r~%{time}~s~ GIÂY',
        request_help = 'ẤN [~r~G~s~] ĐỂ GỬI YÊU CẦU TRỢ GIÚP',
