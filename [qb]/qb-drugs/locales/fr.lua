local Translations = {
    ...
    info = {
        ...
        newdealer_command_desc = "Placer un dealeur (Admin)",
        ...
        deletedealer_command_desc = "Supprimer un dealeur (Admin)",
        deletedealer_command_help1_name = "nom",
        deletedealer_command_help1_help = "Nom du Dealeur",
        dealers_command_desc = "Voir tout les dealeurs (Admin)",
        dealergoto_command_desc = "Se teleporter a un dealeur (Admin)",
