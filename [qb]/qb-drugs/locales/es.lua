local Translations = {
    ...
    info = {
        ...
        newdealer_command_desc = "Colocar un dealer (Admin)",
        ...
        deletedealer_command_desc = "Eliminar un dealer (Admin)",
        deletedealer_command_help1_name = "nombre",
        deletedealer_command_help1_help = "Nombre de Dealer",
        dealers_command_desc = "Ver a todos los dealer (Admin)",
        dealergoto_command_desc = "Teletransportarse a un dealer (Admin)",
