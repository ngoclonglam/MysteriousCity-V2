local Translations = {
    ...
    info = {
        ...
        newdealer_command_desc = "Place a dealer (Admin)",
        ...
        deletedealer_command_desc = "Delete a dealer (Admin)",
        deletedealer_command_help1_name = "name",
        deletedealer_command_help1_help = "Dealer name",
        dealers_command_desc = "View all dealers (Admin)",
        dealergoto_command_desc = "Teleport to a dealer (Admin)",
