local Translations = {
    ...
    commands = {
        ["blips_for_player"] = "Visa blips för spelare (Admin)",
        ["player_name_overhead"] = "Visa namn över huvudet (Admin)",
        ["coords_dev_command"] = "Coords för utvecklare (Admin)",
        ["toogle_noclip"] = "Noclip (Admin)",
        ["save_vehicle_garage"] = "Spara fordon till garage (Admin)",
        ["make_announcement"] = "Gör ett uttalande (Admin)",
        ["open_admin"] = "Öppna admin menyn (Admin)",
        ["staffchat_message"] = "Staffmeddelande (Admin)",
        ["nui_focus"] = "Ge spelare NUI Focus (Admin)",
        ["warn_a_player"] = "Varna (Admin)",
        ["check_player_warning"] = "Kolla varningar (Admin)",
        ["delete_player_warning"] = "Ta bort varning (Admin)",
        ["reply_to_report"] = "Svara på en rapportering (Admin)",
        ["change_ped_model"] = "Byt PED (Admin)",
        ["set_player_foot_speed"] = "Sätt spelares fart (Admin)",
        ["report_toggle"] = "Toggla inkommande rapporteringar (Admin)",
        ["kick_all"] = "Kicka alla spelare",
        ["ammo_amount_set"] = "Sätt ammo (Admin)",
    }
}
