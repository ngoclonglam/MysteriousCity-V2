local Translations = {
    ...
    commands = {
        ["blips_for_player"] = "Affiche les blips des joueurs (Admin)",
        ["player_name_overhead"] = "Affiche le nom des joueurs (Admin)",
        ["coords_dev_command"] = "Affiche les coordonnées pour le dev (Admin)",
        ["toogle_noclip"] = "Active le noclip (Admin)",
        ["save_vehicle_garage"] = "Sauvegarde un véhicule dans votre garage (Admin)",
        ["make_announcement"] = "Fais une Annonce (Admin)",
        ["open_admin"] = "Ouvre le menu Admin (Admin)",
        ["staffchat_message"] = "Envoie un message a tous les staffs (Admin)",
        ["nui_focus"] = "Donner a un joueur le Focus NUI (Admin)",
        ["warn_a_player"] = "Warn Un Joueur (Admin)",
        ["check_player_warning"] = "Check Les Warns d'un joueur (Admin)",
        ["delete_player_warning"] = "Supprime les Warns d'un joueur (Admin)",
        ["reply_to_report"] = "Répond a un report (Admin)",
        ["change_ped_model"] = "Change le modèle du Ped (Admin)",
        ["set_player_foot_speed"] = "Défini la vitesse du joueur (Admin)",
        ["report_toggle"] = "Active les reports (Admin)",
        ["kick_all"] = "Kick tout les joueurs",
        ["ammo_amount_set"] = "Défini vos munitions (Admin)",
    }
}
