local Translations = {
    ...
    commands = {
        ["blips_for_player"] = "Show blips for players (Admin)",
        ["player_name_overhead"] = "Show player name overhead (Admin)",
        ["coords_dev_command"] = "Enable coord display for development stuff (Admin)",
        ["toogle_noclip"] = "Toggle noclip (Admin)",
        ["save_vehicle_garage"] = "Save Vehicle To Your Garage (Admin)",
        ["make_announcement"] = "Make An Announcement (Admin)",
        ["open_admin"] = "Open Admin Menu (Admin)",
        ["staffchat_message"] = "Send A Message To All Staff (Admin)",
        ["nui_focus"] = "Give A Player NUI Focus (Admin)",
        ["warn_a_player"] = "Warn A Player (Admin)",
        ["check_player_warning"] = "Check Player Warnings (Admin)",
        ["delete_player_warning"] = "Delete Players Warnings (Admin)",
        ["reply_to_report"] = "Reply To A Report (Admin)",
        ["change_ped_model"] = "Change Ped Model (Admin)",
        ["set_player_foot_speed"] = "Set Player Foot Speed (Admin)",
