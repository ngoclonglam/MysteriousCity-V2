...
// DISCORD BOT
const DiscordBotToken = "OTk5NzIwODQ5OTI4MDkzNzk3.GFSiUx.7qpzx9ZBZRggyMTr3qXKWwFXn4tHCqOwy225JQ";
const DiscordGuildId = "987098899099574272";

// STAFF CHAT
const EnableStaffChatForwarding = true;
const DiscordStaffChannelId = "1006179184353230918";
...
const DiscordWhitelistRoleIds = "987752955451150397, 987718151372415029";

// SLASH COMMANDS / DISCORD PERMISSIONS
const EnableDiscordSlashCommands = true;
const DiscordModRoleId = "987157553991528478";
const DiscordAdminRoleId = "987102823034544258";
const DiscordGodRoleId = "987102106529988699";
