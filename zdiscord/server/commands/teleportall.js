...
module.exports = {
            ...
            options: [
                {
                    ...
                    choices: [
                        ...
                        { name: "Garage Trung Tâm", value: "garage" },
                        { name: "Car Dealer", value: "cardealer"},
                        { name: "Chuộc Xe", value: "depot"},
                    ],
                },
            ],
        },
    ...
    run: async (client, interaction, args) => {
        const locations = {
            ...
            "garage": [ 215.67, -808.79, 30.75 ],
            "cardealer": [ -346.64, -873.99, 31.1 ],
            "depot": [ 403.5, -1631.66, 28.68 ],
        };
        if (args.coords) {
