...
RegisterNetEvent('hud:server:GainStress', function(amount)
    ...
    local newStress
    if not Player or (Config.DisablePoliceStress and Player.PlayerData.job.name == 'police') or (Config.DisableEmsStress and Player.PlayerData.job.name == 'ambulance') then return end
