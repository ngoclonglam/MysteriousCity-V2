...
local djparty = BoxZone:Create(Config.Locations['djparty'].coords, 1, 1, {
    name="djparty",
    heading=0
})

djparty:onPlayerInOut(function(isPointInside)
    if isPointInside and PlayerData.job.name == Config.Locations['djparty'].job then
        currentZone = 'djparty'
