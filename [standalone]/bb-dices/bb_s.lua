...
QBCore.Functions.CreateUseableItem('dice' , function(source)
	local Player = QBCore.Functions.GetPlayer(source)

	if not Player then return end
	Player.Functions.RemoveItem('dice', 1)
	TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["dice"], "remove")
	Wait(1000)
