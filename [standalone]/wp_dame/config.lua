...
Config.Weapons = {
    ...
    [`WEAPON_FLASHLIGHT`] = {model = `WEAPON_FLASHLIGHT`, modifier = 0.01, disableCritical = true},
    [`WEAPON_KNIFE`]     = {model = `WEAPON_KNIFE`, modifier = 0.2835, disableCritical = true},
    [`WEAPON_BATTLEAXE`] = {model = `WEAPON_BATTLEAXE`, modifier = 0.001, disableCritical = true},
    -- [`WEAPON_KNUCKLE`] = {model = `WEAPON_KNUCKLE`, modifier = 0.1, disableCritical = true},
    -- [`WEAPON_NIGHTSTICK`] = {model = `WEAPON_NIGHTSTICK`, modifier = 0.2, disableCritical = true},
    -- [`WEAPON_HAMMER`] = {model = `WEAPON_HAMMER`, modifier = 0.1, disableCritical = true},
    -- [`WEAPON_BAT`] = {model = `WEAPON_BAT`, modifier = 0.2, disableCritical = true},
    ...
    [`WEAPON_HATCHET`] = {model = `WEAPON_HATCHET`, modifier = 0.001, disableCritical = true},
    ...
    -- [`WEAPON_PISTOL`] = {model = `WEAPON_PISTOL`, modifier = 0.3, disableCritical = true},
    -- [`WEAPON_PISTOL_MK2`] = {model = `WEAPON_PISTOL_MK2`, modifier = 0.4, disableCritical = true},
    -- [`WEAPON_COMBATPISTOL`] = {model = `WEAPON_COMBATPISTOL`, modifier = 0.4, disableCritical = true},
    -- [`WEAPON_APPISTOL`] = {model = `WEAPON_APPISTOL`, modifier = 0.4, disableCritical = true},
    -- [`WEAPON_PISTOL50`] = {model = `WEAPON_PISTOL50`, modifier = 0.1, disableCritical = true},
    -- [`WEAPON_SNSPISTOL`] = {model = `WEAPON_SNSPISTOL`, modifier = 0.5, disableCritical = true},
    ...
    -- [`WEAPON_SMG`] = {model = `WEAPON_SMG`, modifier = 0.5, disableCritical = true},
    ...
    -- [`WEAPON_PUMPSHOTGUN`] = {model = `WEAPON_PUMPSHOTGUN`, modifier = 0.14, disableCritical = true},
    -- [`WEAPON_CARBINERIFLE`] = {model = `WEAPON_CARBINERIFLE`, modifier = 0.35, disableCritical = true},
    -- [`WEAPON_MACHINEPISTOL`] = {model = `WEAPON_MACHINEPISTOL`, modifier = 0.65, disableCritical = true},
}