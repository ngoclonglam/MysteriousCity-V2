...
Config = {
	...
	Consumables = {
		...
		["meoburger"] = {
			...
			type = "food",								-- Type: "alcohol" / "drink" / "food"
			stats = {
				screen = "focus",						-- The screen effect to be played when after consuming the item
				effect = "heal", 						-- The status effect given by the item, "heal" / "stamina"
				time = 5000,							-- How long the effect should last (if not added it will default to 10000)
				amount = 0,								-- How much the value is changed by per second
				hunger = 25,							-- The hunger/thirst stats of the item, if not found in the items.lua
				thirst = 0,								-- The hunger/thirst stats of the item, if not found in the items.lua
			},
		},
		["cammeo"] = {
			emote = "boba4", 							-- Select an emote from below, it has to be in here
			time = math.random(5000, 6000),				-- Amount of time it takes to consume the item
			stress = math.random(1,2),					-- Amount of stress relief, can be 0
			heal = 0, 									-- Set amount to heal by after consuming
			armor = 0,									-- Amount of armor to add
			...
			stats = {
				...
				time = 5000,							-- How long the effect should last (if not added it will default to 10000)
				amount = 0,								-- How much the value is changed by per second
				hunger = 0,							-- The hunger/thirst stats of the item, if not found in the items.lua
				thirst = 25,								-- The hunger/thirst stats of the item, if not found in the items.lua
			},
		},
		["comnammeo"] = {
		...
		["cafesua"] = {
			...
			stats = {
				...
				amount = 0,								-- How much the value is changed by per second
				hunger = 0,								-- The hunger/thirst stats of the item, if not found in the items.lua
				thirst = 40,							-- The hunger/thirst stats of the item, if not found in the items.lua
			},
		},
		["keodeomeo"] = {
			emote = "mochi", 							-- Select an emote from below, it has to be in here
			time = math.random(5000, 6000),				-- Amount of time it takes to consume the item
			stress = math.random(1,2),					-- Amount of stress relief, can be 0
			heal = 0, 									-- Set amount to heal by after consuming
			armor = 0,									-- Amount of armor to add
			...
			stats = {
				screen = "rampage",						-- The screen effect to be played when after consuming the item
				effect = "luck", 						-- The status effect given by the item, "heal" / "stamina"
				time = 15000,							-- How long the effect should last (if not added it will default to 10000)
				hunger = 0,								-- The hunger/thirst stats of the item, if not found in the items.lua
				thirst = 0,								-- The hunger/thirst stats of the item, if not found in the items.lua
			},
		},
		["banhquymeo"] = {
			emote = "sandwich", 						-- Select an emote from below, it has to be in here
			time = math.random(5000, 6000),				-- Amount of time it takes to consume the item
			stress = math.random(1,2),					-- Amount of stress relief, can be 0
			heal = 0, 									-- Set amount to heal by after consuming
			armor = 0,									-- Amount of armor to add
			type = "food",								-- Type: "alcohol" / "drink" / "food"
			stats = {
				screen = "turbo",						-- The screen effect to be played when after consuming the item
				effect = "stamina", 					-- The status effect given by the item, "heal" / "stamina"
				time = 15000,							-- How long the effect should last (if not added it will default to 10000)
				amount = 1.5,								-- How much the value is changed by per second
				hunger = 0,								-- The hunger/thirst stats of the item, if not found in the items.lua
				thirst = 0,								-- The hunger/thirst stats of the item, if not found in the items.lua
			},
		},
		["kemmeo"] = {
			...
			stats = {
				screen = "turbo",						-- The screen effect to be played when after consuming the item
				effect = "swimming", 					-- The status effect given by the item, "heal" / "stamina"
				time = 15000,							-- How long the effect should last (if not added it will default to 10000)
				amount = 1.5,							-- How much the value is changed by per second
				hunger = 0,								-- The hunger/thirst stats of the item, if not found in the items.lua
				thirst = 0,								-- The hunger/thirst stats of the item, if not found in the items.lua
		...
		["gaquay"] = {
			emote = "foodbowl", 						-- Select an emote from below, it has to be in here
			time = math.random(5000, 6000),				-- Amount of time it takes to consume the item
			stress = 0,									-- Amount of stress relief, can be 0
			heal = 0, 									-- Set amount to heal by after consuming
			armor = 0,									-- Amount of armor to add
			type = "food",								-- Type: "alcohol" / "drink" / "food"
			stats = {
		...
		["supvica"] = {
			emote = "foodbowl", 						-- Select an emote from below, it has to be in here
			time = math.random(5000, 6000),				-- Amount of time it takes to consume the item
			stress = 10,									-- Amount of stress relief, can be 0
			heal = 0, 									-- Set amount to heal by after consuming
			armor = 0,									-- Amount of armor to add
			type = "food",								-- Type: "alcohol" / "drink" / "food"
			stats = {
