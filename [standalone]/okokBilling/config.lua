...
Config.InvoicesCommand = 'hoadon' -- Command used to open the invoices menu
...
Config.LimitDateDays = 3 -- If Config.LimitDate is enabled, it is used to define the days of the deadline for payment after issuing the invoice
...
Config.FeeAfterEachDayPercentage = 20 -- If Config.FeeAfterEachDay is enabled, it is used to set the fee percentage after each day
...
Config.ServerName = 'Mysterious City' -- Write your server's name
