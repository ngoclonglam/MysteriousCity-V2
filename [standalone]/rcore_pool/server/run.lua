...
AddEventHandler('rcore_pool:payForPool', function(source, cb)
    local xPlayer = QBCore.Functions.GetPlayer(source)
    if xPlayer.Functions.RemoveMoney('cash', Config["BallSetupCost"]) then
        cb(true)
    elseif xPlayer.Functions.RemoveMoney('bank', Config["BallSetupCost"]) then
        cb(true)
    else
        return cb(false)
    end
