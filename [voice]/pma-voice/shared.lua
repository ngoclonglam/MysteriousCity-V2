...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.5, "Thầm Thì"}, -- Whisper speech distance in gta distance units
		{3.0, "Bình Thường"}, -- Normal speech distance in gta distance units
		{6.0, "La Hét"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "Thầm Thì"}, -- Whisper speech distance in gta distance units
		{7.0, "Normal"}, -- Normal speech distance in gta distance units
		{15.0, "La Hét"} -- Shout speech distance in gta distance units
	}
end
